...
/** 
 * this method makes it caluculate how far to get to cursor
 *and starts the move
 *
...
function causeMoverTrip(evt){
    ...
    //calculate the overall distance the mover has to travel, subtracting the DIV's X from the mouses' X, converting Div's X to an integer
    ...
    //reset counter and interval for new trip
    clearInterval(move_timer);
        timer_counter= 0;
